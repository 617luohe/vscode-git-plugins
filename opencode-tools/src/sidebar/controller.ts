...
export type ControllerHost = {
  readonly treeView: {
    ...
    readonly onDidChangeVisibility: (listener: (event: boolean) => void) => { dispose: () => void }
  }
...
const INSTALL_COMMAND = "opencode-tools.installOpenCode"
...
export { INSTALL_COMMAND, OPEN_COMMAND }
